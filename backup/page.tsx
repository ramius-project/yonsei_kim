    ...
    <main className="flex flex-col items-center min-h-screen bg-gray-50 pb-20">
      ...
      <header className="w-full fixed top-0 bg-white/90 backdrop-blur-sm shadow-sm z-10 px-6 py-4 flex justify-between items-center max-w-5xl mx-auto">
        ...
        <nav className="hidden md:flex space-x-8 text-gray-600 font-medium text-sm">
          ...
          <a href="#schedule" className="hover:text-blue-600 transition">월간스케줄</a>
      ...
      {/* 2. 히어로 섹션 */}
      <section className="mt-24 w-full max-w-5xl px-6 py-12 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        {/* 이번달 스케줄 달력 UI (기존 사진 위치) */}
        <div id="schedule" className="lg:w-7/12 w-full flex justify-center">
          <MonthlyCalendar />
        </div>
      </section>
